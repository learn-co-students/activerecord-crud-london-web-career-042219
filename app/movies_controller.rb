...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  Movie.find_by(release_date: 2000, director: "Me", title: "Title")
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by 
  # release date descending
  films = Movie.where(release_date: (2003..3000))
...
def can_be_found_updated_and_saved
  ...
  film = Movie.find_by(title: "Awesome Flick")
  film.update(title: "Even Awesomer Flick")
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  film = Movie.find_by(title: "Wat?")
  film.update(title: "Wat, huh?")
...
def can_destroy_a_single_item
  ...
  film = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  film.destroy
